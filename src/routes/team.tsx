...
export const Route = createFileRoute("/team")({
  ...
  head: () => ({
    meta: [
      { title: "Team — Genix" },
      { name: "description", content: "Meet the core team behind Genix — GTBIT's tech society." },
      { property: "og:title", content: "Team — Genix" },
      { property: "og:description", content: "The people who run Genix at GTBIT." },
    ],
  }),
});

const team = [
  { name: "Gunit Singh", role: "President", img: gunit.url, quote: "Ideas beat titles. Ship the thing." },
  { name: "Gurnoor Singh", role: "Vice President", img: gurnoor.url, quote: "Build hard, stay curious." },
  { name: "Jasnoor Kaur", role: "Head of Operations", img: jasnoor.url, quote: "Great events are 90% details." },
  { name: "Agamjot Singh", role: "Executive Director", img: agamjot.url, quote: "The best community learns loud." },
];
