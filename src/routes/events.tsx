...
export const Route = createFileRoute("/events")({
  ...
  head: () => ({
    meta: [
      { title: "Events — Genix" },
      { name: "description", content: "Upcoming events and past highlights from Genix, GTBIT's tech society — including our flagship Tech Debate." },
      { property: "og:title", content: "Events — Genix" },
      { property: "og:description", content: "See what's next at Genix and revisit our flagship Tech Debate event." },
    ],
  }),
});
        ...
        <div className="mt-12 grid grid-cols-6 gap-3 md:gap-4">
          <Reveal className="col-span-6 md:col-span-4">
            <figure className="rounded-2xl overflow-hidden border border-border">
              <img src={event1.url} alt="Genix Tech Debate participants" className="w-full aspect-[16/9] object-cover" />
          ...
          <Reveal className="col-span-6 md:col-span-2" delay={0.08}>
            <figure className="rounded-2xl overflow-hidden border border-border h-full">
              <img src={event3.url} alt="Faculty at Tech Debate" className="w-full h-full aspect-[3/4] object-cover" />
            </figure>
          </Reveal>
          <Reveal className="col-span-6 md:col-span-6" delay={0.12}>
            <figure className="rounded-2xl overflow-hidden border border-border">
              <img src={event2.url} alt="Tech Debate group photo" className="w-full aspect-[21/9] object-cover" />
