...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About — Genix" },
      { name: "description", content: "The story of Genix — GTBIT's official tech society. Our mission, what we do, and how to join." },
      { property: "og:title", content: "About — Genix" },
      { property: "og:description", content: "Learn about Genix, GTBIT's tech society, and how to become a member." },
    ],
  }),
});
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <Reveal delay={0.1}>
            <div className="grid grid-cols-3 gap-2">
              {[event1.url, event2.url, event3.url, event2.url, event3.url, event1.url].map((src, i) => (
                <a key={i} href="https://www.instagram.com/genix.gtbit" target="_blank" rel="noreferrer" className="group relative block aspect-square rounded-xl overflow-hidden border border-border">
                  <img src={src} alt="" className="h-full w-full object-cover group-hover:scale-110 transition-transform duration-700" loading="lazy" />
                </a>
              ))}
            </div>
          </Reveal>
